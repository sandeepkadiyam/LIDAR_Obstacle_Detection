...
void clusterHelper(int indice, const std::vector<std::vector<float>> points, std::vector<int>& cluster, KdTree* tree, std::vector<bool>& processed, float distanceTol) {
...
std::vector<std::vector<int>> euclideanCluster(const std::vector<std::vector<float>>& points, KdTree* tree, float distanceTol)
{
	...
	while(i < points.size()) {
		...
		clusterHelper(i, points, cluster, tree, processed, distanceTol);
