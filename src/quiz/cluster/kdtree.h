...
struct KdTree
{
	...
	void insertHelper3D (Node** node, int depth, std::vector<float> point, int id) {
	...
	void searchHelper3D(Node* node, int depth, std::vector<float> target, float distanceTol, std::vector<int> &ids){
